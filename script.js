...
var questions = [
    question0 = {
        question:
            "JavaScript is written under which tag?",
        incorrect: [
    ...
    question1 = {
        question:
            "A variable in JS is declared with which keyword?",
        incorrect: [
            "New",
            "int",
            "string",
    ...
    question2 = {
        question:
            "Which primitive data type is in JS?",
        incorrect: [
            "String",
            "number",
            "boolean",
    ...
    question4 = {
        question:
            "Which object represents parameters of a current function inside any function?",
        incorrect: [
            "Global",
            "this",
            "Object"
    ...
    question5 = {
        question:
            "A function can be assigned to a variable in JS?",
        incorrect: [
            "False"
        ],
        answer: "True"
